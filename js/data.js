...
// Helper function to find all professors assigned to a specific chemistry subfield
function getFacultyByField(facultyList, fieldName) {
    return facultyList.filter(f => f.field === fieldName);
}
